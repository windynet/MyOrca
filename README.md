...
- **[Launcher Bar](https://github.com/stablyai/orca/wiki/Launcher-Bar)** — Pin your most-used terminals and URLs as icon shortcuts on the right sidebar; open them with one click.
